...
import type { ScrollNewsComment } from '../../../../features/scroll-news/model/types';
...
export function CommentRowItem(props: {
  ...
  return (
    <View style={styles.commentRow}>
      ...
      <Pressable style={styles.commentLikeWrap} onPress={onToggleLike} hitSlop={8}>
        <Text
          style={[styles.commentLikeIcon, liked && styles.commentLikeIconActive]}
        >
          {liked ? '♥' : '♡'}
        </Text>
